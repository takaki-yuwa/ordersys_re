...
public class OrderList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(urlDetailsAdd.equals(pageName)) {
			...
			List<Integer> topping_price = new ArrayList<Integer>(Arrays.asList(110,110,110,110,110,110));
			...
			List<String> topping_name = (strToppingName != null) ? new ArrayList<String>(Arrays.asList(strToppingName)) : new ArrayList<String>();;
			...
			orderList.add(new order_list(order_id, iProductId, topping_id, product_name, category_name, topping_name, product_price, topping_price,
